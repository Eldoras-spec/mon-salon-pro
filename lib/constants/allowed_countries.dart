...
const List<Country> kAllowedCountries = [
  ...
  Country(code: 'IT', name: 'Italie', dial: '+39', flag: '🇮🇹'),
  Country(code: 'DE', name: 'Allemagne', dial: '+49', flag: '🇩🇪'),
  Country(code: 'NL', name: 'Pays-Bas', dial: '+31', flag: '🇳🇱'),
  Country(code: 'AT', name: 'Autriche', dial: '+43', flag: '🇦🇹'),
  Country(code: 'FI', name: 'Finlande', dial: '+358', flag: '🇫🇮'),
  Country(code: 'GR', name: 'Grèce', dial: '+30', flag: '🇬🇷'),
